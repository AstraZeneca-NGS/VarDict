...
d <- tryCatch( {
    read.table( args[1], sep = "\t", header = F, colClasses=c("character", NA, NA, NA, NA, "character", "character", NA, NA, NA, NA, NA, NA, "character", NA, NA, NA, NA, NA, NA, NA, NA))
}, error = function(e) {
    return(NULL)
} )
